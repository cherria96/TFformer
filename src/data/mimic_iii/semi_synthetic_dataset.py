...
synth_outcomes_list = SyntheticOutcomeGenerator
synth_treatments_list = SyntheticTreatment
treatment_outcomes_influence = {'y1':{t1, t2}, 'y2': {t2, t3}}
MIMICdatasetcollection = MIMIC3SyntheticDatasetCollection(
    ...
    min_seq_length = 20, max_seq_length = 100,
    max_number = 200
)